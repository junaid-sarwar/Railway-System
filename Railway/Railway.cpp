...
login:
	...
	if (user == "Junaid" && password == "JUNAID30" || user == "Shahood" && password == "SHAHOOD29" || user == "Jaffar" && password == "JAFFAR49")
	{
...
relog:
	...
	cout << "\n\n\t\t\t\t\t\t--------------------"; Sleep(500);
	cout << "\n\n\t\t\t\t     S.M.Junaid Sarwar       2023F-BCS-030"; Sleep(1000);
	cout << "\n\n\t\t\t\t     Muhammad Shahood        2023F-BCS-029"; Sleep(2000);
	cout << "\n\n\t\t\t\t     Muhammad Jaffar         2023F-BCS-049"; Sleep(3000);
	cout << endl;
	system("cls");
log:
